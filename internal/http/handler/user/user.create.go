...
var ExampleUserCreateHandlerModuleFx = fx.Options(
	fx.Provide(xhuma.AnnotateHandlerAs(NewExampleUserCreateHandlerFx)),
)
...
func NewExampleUserCreateHandlerFx(p ExampleUserCreateHandlerParamFx) ExampleUserCreateHandlerFx {
...
func (h ExampleUserCreateHandlerFx) Serve(ctx context.Context, in *ExampleUserCreateRequestInput) (out *ExampleUserCreateResponseOutput, err error) {
	d, err := h.p.ExUserSvc.Create(ctx, attr.ExampleUserCreate{
		Name: in.Body.Name,
		Age:  in.Body.Age,
	})
	if err != nil {
